...
function renderAnalytics() {
  ...
  if (typeof Chart === 'undefined') return; // Chart.js failed to load (offline CDN?) — skip charts, stats above still work
...
async function updateLastSeen() {
  ...
  await sb.from('profiles').update({ last_seen_at: now }).eq('id', currentUser.id);
